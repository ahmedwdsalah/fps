...
> **Fused from:**
> - brand: `/Users/ahmed/.agents/skills/ppt-master/templates/brands/anthropic/` (identity override: color, typography direction, logo, icon tone)
> - layout: `/Users/ahmed/.agents/skills/ppt-master/templates/layouts/academic_defense/` (structure override: cover, chapter, content, ending page system)
> - conflicts resolved: identity from Anthropic/Claude, structure from academic_defense, with defense-specific content strategy from `pptx.md`
