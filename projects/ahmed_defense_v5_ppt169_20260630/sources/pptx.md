...
- Defense deck target: 22 slides total.
...
Target length: 22 slides total. If time pressure forces trimming later, merge slides 3-4 or slides 20-21, but do not create an appendix.
